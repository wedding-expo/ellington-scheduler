<?php /* Smarty version Smarty-3.1.7, created on 2013-10-10 19:08:41
         compiled from "/Users/pianoman320/Sites/scheduler/lib/Common/../../tpl/Install/install.tpl" */ ?>
<?php /*%%SmartyHeaderCode:109656596352575da9ad5574-99670145%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d406290673b7f500d173ca0749ebc3ad51b0c08' => 
    array (
      0 => '/Users/pianoman320/Sites/scheduler/lib/Common/../../tpl/Install/install.tpl',
      1 => 1365101124,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '109656596352575da9ad5574-99670145',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52575da9ca92c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52575da9ca92c')) {function content_52575da9ca92c($_smarty_tpl) {?>
...
">
        ...
        <?php if ($_smarty_tpl->tpl_vars['InstallPasswordMissing']->value){?>
            <div class='error'>
                ...
                <p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'InstallPasswordInstructions','args'=>($_smarty_tpl->tpl_vars['ConfigPath']->value).",".($_smarty_tpl->tpl_vars['ConfigSetting']->value).",".($_smarty_tpl->tpl_vars['SuggestedInstallPassword']->value)),$_smarty_tpl);?>
</p>
            </div>
        <?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['ShowPasswordPrompt']->value){?>
            <ul class="no-style">
                ...
                <li><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'InstallPasswordLocation','args'=>($_smarty_tpl->tpl_vars['ConfigPath']->value).",".($_smarty_tpl->tpl_vars['ConfigSetting']->value)),$_smarty_tpl);?>
</li>
...
<br/>
				...
				<?php if ($_smarty_tpl->tpl_vars['ShowUpgradeOptions']->value){?>
					<li>3) <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'UpgradeNotice','args'=>($_smarty_tpl->tpl_vars['CurrentVersion']->value).",".($_smarty_tpl->tpl_vars['TargetVersion']->value)),$_smarty_tpl);?>
</li>
					<li>
...
</a> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'RegisterAdminUser','args'=>($_smarty_tpl->tpl_vars['ConfigPath']->value)),$_smarty_tpl);?>
<br/><br/>
					<a href="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
